...
class Tabs(QTabWidget):
    ...
    def __init__(self, main_toolbar):
        ...
        self.main_toolbar.add_link(
            self, status_index, self.TAB_STATUS, "multimedia-volume-control"
        )
        ...
        self.main_toolbar.add_link(
            self, measuring_index, self.TAB_MEASURING, "x-office-spreadsheet"
        )
        ...
        self.main_toolbar.add_link(
            self, programms_index, self.TAB_PROGRAMMS, "x-office-spreadsheet"
        )
